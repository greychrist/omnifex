      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            {/* OmniFex logo slides left; brand text reveals to the right */}
...
function BrandText() {
  return (
    <div className="text-5xl font-extrabold tracking-tight brand-text pb-2">
      <span className="brand-text-solid">OmniFex</span>
      <span aria-hidden="true" className="brand-text-shimmer">OmniFex</span>
    </div>
  );
}
