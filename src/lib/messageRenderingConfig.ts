...
export const KIND_REGISTRY: Record<string, KindDef> = {
  ...
  "system.thinking_tokens": { id: "system.thinking_tokens", category: "system", label: "Thinking tokens", description: "Total size of each extended-thinking burst. The live running count is the ThinkingBar, not this row.", default: { presentation: "side-line", icon: "Brain", accentColor: "muted", hiddenInCompact: true } },
