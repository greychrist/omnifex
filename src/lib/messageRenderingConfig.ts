...
export const KIND_REGISTRY: Record<string, KindDef> = {
  ...
  "system.thinking_tokens": { id: "system.thinking_tokens", category: "system", label: "Thinking tokens", description: "Running thinking-size estimates emitted during extended thinking.", default: { presentation: "side-line", icon: "Brain", accentColor: "muted", hiddenInCompact: true } },
