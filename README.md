...
- Session rows are headed by the name Claude Code gives the session itself, with an **on-demand, cached summary** generated by a model call sitting underneath it.
